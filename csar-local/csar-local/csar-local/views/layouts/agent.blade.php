...
<head>
    ...
    <title>@yield('title', 'CSAR Agent')</title>
    ...
    <aside class="agent-sidebar" id="agentSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('agent.hr.index') }}" class="nav-item {{ request()->routeIs('agent.hr.index') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-users"></i>
                    <span class="nav-text">Accueil RH</span>
                </a>
                
                <a href="{{ route('agent.hr.documents.index') }}" class="nav-item {{ request()->routeIs('agent.hr.documents.*') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-file-alt"></i>
                    <span class="nav-text">Documents</span>
                </a>
                
                <a href="{{ route('agent.hr.salary-slips.index') }}" class="nav-item {{ request()->routeIs('agent.hr.salary-slips.*') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-money-bill-wave"></i>
                    <span class="nav-text">Bulletins de salaire</span>
                </a>
                
                <a href="{{ route('agent.hr.attendance.index') }}" class="nav-item {{ request()->routeIs('agent.hr.attendance.*') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-clock"></i>
                    <span class="nav-text">Présence</span>
                </a>
                
                <a href="{{ route('agent.hr.statistics') }}" class="nav-item {{ request()->routeIs('agent.hr.statistics') ? 'active' : '' }}">
