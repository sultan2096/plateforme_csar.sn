...
@section('title', 'Ajouter une image de fond')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ajouter une image de fond</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Format recommandé : 1920x1080px. Taille maximale : 5MB.</small>
