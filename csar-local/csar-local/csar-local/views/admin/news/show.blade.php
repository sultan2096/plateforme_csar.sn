...
<div class="show-news-container">
    ...
    <div class="actions-section">
        ...
        <div class="actions-grid">
            <a href="{{ route('admin.news.edit', $news) }}" class="action-btn edit">
                <i class="fas fa-edit"></i>
                Modifier
            </a>
            
            @if($news->is_published)
                <button class="action-btn toggle" onclick="togglePublish()">
            ...
            <button class="action-btn delete" onclick="deleteNews()">
                <i class="fas fa-trash"></i>
                Supprimer
            </button>
            
            <a href="{{ route('admin.news.index') }}" class="action-btn back">
...
function togglePublish() {
    if (confirm('Êtes-vous sûr de vouloir changer le statut de publication de cette actualité ?')) {
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = '{{ route("admin.news.toggle-publish", $news) }}';
