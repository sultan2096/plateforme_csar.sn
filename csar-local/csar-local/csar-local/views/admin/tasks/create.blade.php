...
@section('title', 'Créer une Tâche - CSAR')
...
<div class="admin-container">
    ...
    <div class="admin-header">
        <div class="admin-header-content">
            <div>
                ...
                <p>Créer et assigner une nouvelle tâche</p>
            </div>
    ...
    <div class="form-container">
        ...
        <div class="form-body">
            <form method="POST" action="{{ route('admin.tasks.store') }}" id="taskCreateForm" onsubmit="handleSubmit(event)">
                @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="priority-preview">
                                <span>Aperçu:</span>
                                <span class="priority-badge priority-medium" id="priorityBadge">Moyenne</span>
                            </div>
                            @error('priority')
                                <div class="invalid-feedback">
                                    <i class="fas fa-exclamation-circle"></i>
                        ...
                        <div class="form-group">
                            <label class="form-label">
                                Statut Initial <span class="required-mark">*</span>
                            </label>
                            <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                @php($status = old('status', 'todo'))
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            ...
                            placeholder="Notes additionnelles, instructions spécifiques...">{{ old('notes') }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">
                                <i class="fas fa-exclamation-circle"></i>
                                {{ $message }}
...
// Initialize with old tags if validation failed
@if(old('tags'))
