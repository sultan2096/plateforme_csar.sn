...
@section('title', 'Détails Personnel - Interface Admin')
...
<div class="admin-content">
    <div class="content-header">
        ...
        <div class="header-actions">
            <a href="{{ route('admin.personnel.export-fiche-pdf', $personnel) }}" class="btn btn-secondary">
                <i class="fas fa-file-pdf"></i> Télécharger la fiche PDF
            </a>
            <a href="{{ route('admin.personnel.edit', $personnel) }}" class="btn btn-warning">
        ...
        <div class="personnel-details">
            ...
            <div class="personnel-header">
                <div class="personnel-photo">
                    <img src="{{ $personnel->photo_url }}" alt="Photo de {{ $personnel->prenoms_nom }}" style="width:120px;height:120px;object-fit:cover;border-radius:12px;border:3px solid #e5e7eb;box-shadow:0 1px 4px #0001; background:#f3f4f6;" onerror="this.src='https://ui-avatars.com/api/?name={{ urlencode($personnel->prenoms_nom) }}'">
                    @if(auth()->user() && auth()->user()->is_admin)
                    <form method="POST" action="{{ route('admin.personnel.deletePhoto', $personnel) }}" style="margin-top:10px;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger btn-sm" style="margin:0 auto;display:block;"><i class="fas fa-trash"></i> Supprimer la photo</button>
                    </form>
                    @endif
                </div>
