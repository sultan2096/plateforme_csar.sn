...
@section('page-subtitle', 'Consultez les actualités de la plateforme CSAR')
...
<div class="news-container">
    ...
    <div class="news-header">
        <div class="news-header-content">
            <h1>📰 Actualités CSAR</h1>
            <p>Consultez toutes les actualités publiées sur la plateforme</p>
    ...
    <div id="gridView" class="news-grid">
                ...
                <div class="card-content">
                    ...
                    <div class="card-meta">
                        ...
                        <div class="card-actions">
                            <a href="{{ route('dg.news.show', $item) }}" class="card-btn view">
        ...
        @empty
            <div class="empty-state" style="grid-column: 1 / -1;">
                ...
                <p class="empty-description">Aucune actualité n'a été publiée pour le moment</p>
            </div>
        @endforelse
    </div>
                        ...
                        <tr data-title="{{ strtolower($item->title) }}" data-type="{{ strtolower($item->type) }}" data-status="{{ $item->is_published ? 'published' : 'draft' }}">
                            ...
                            <td>
                                <div class="table-actions">
                                    <a href="{{ route('dg.news.show', $item) }}" class="table-btn view">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                </div>
                            </td>
