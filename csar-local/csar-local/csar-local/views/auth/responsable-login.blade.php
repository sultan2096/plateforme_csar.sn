...
<body>
    <div class="login-container">
        <div class="login-header">
            ...
            <p>Accédez à votre espace de gestion d'entrepôt</p>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="email" 
                               ...
                               id="email" 
                               name="email" 
                               value="{{ old('email', 'responsable@csar.sn') }}" 
    ...
    <div class="w-full max-w-xs">
        <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-xl p-2 border border-white/20 login-card">
            ...
            <div class="text-center mb-6">
                ...
                <h1 class="text-base font-bold text-gray-900 mb-1 login-title">Connexion Entrepôt</h1>
                <p class="text-gray-600 text-xs login-subtitle">Accédez à votre espace de gestion d'entrepôt</p>
            </div>
            
            <!-- Login Form -->
            <form action="{{ route('responsable.login.submit') }}" method="POST" class="space-y-4">
                @csrf
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
                            <svg class="h-2 w-2 text-gray-400 group-focus-within:text-red-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207"></path>
                            </svg>
                        </div>
                        <input id="email" name="email" type="email" required 
                               class="w-full pl-8 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 login-input bg-white/50 backdrop-blur-sm"
                               placeholder="responsable@csar.sn"
                               value="{{ old('email', 'responsable@csar.sn') }}">
                    </div>
                    @error('email')
                ...
                <div class="text-right">
                    <a href="#" class="text-xs text-red-600 hover:text-red-500 font-medium transition duration-200 hover:underline">
                        Mot de passe oublié ?
                    </a>
                </div>

                <!-- Login Button -->
                <button type="submit" class="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-medium py-2.5 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg login-button">
            ...
            <div class="mt-4 pt-4 border-t border-gray-200/50">
                <div class="bg-red-50/50 rounded-lg p-3 border border-red-200/50 test-credentials">
                    <p class="text-xs text-red-800 mb-2 font-medium flex items-center">
                        <svg class="w-1.5 h-1.5 mr-0.5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="text-xs text-red-700 space-y-0.5">
                        <p><span class="font-medium">Email:</span> responsable@csar.sn</p>
